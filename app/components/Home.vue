<template>
	<Page ref="homepage" class="page"  actionBarHidden="true" backgroundSpanUnderStatusBar="true" @navigatingTo="pageStatusBar" @navigatedTo="pageStatusBar" @navigatingFrom="pageStatusBar" @navigatedFrom="pageStatusBar" @loaded="pageLoaded">
		...
		<GridLayout rows="auto,*,auto" columns="*">
			<GridLayout row="2" :class="navigationClass('')" rows="auto,auto" columns="auto,*,auto,*,auto,*,auto">
			...
			<GridLayout row="0" android:style="margin-top:24" rows="auto,auto" columns="*">
				<label row="1" class="hr-light" />
				<GridLayout row="0" verticalAlignment="middle" minHeight="30" rows="auto" columns="*,*,*" :visibility="visibleTab('about') ? 'visible' : 'collapse'">
				...
				<GridLayout row="0" verticalAlignment="middle" minHeight="30" rows="auto" columns="*,*,*" :visibility="visibleTab('wallets') ? 'visible' : 'collapse'">
				...
				<GridLayout row="0" verticalAlignment="middle" minHeight="30" rows="auto" columns="*,*,*" :visibility="visibleTab('actions') ? 'visible' : 'collapse'">
				...
				<GridLayout row="0" verticalAlignment="middle" minHeight="30" rows="auto" columns="*,*,*" :visibility="visibleTab('settings') ? 'visible' : 'collapse'">
